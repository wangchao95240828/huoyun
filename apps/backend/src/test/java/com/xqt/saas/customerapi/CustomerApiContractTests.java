...
class CustomerApiContractTests {
    ...
    void balanceEndpointReturnsListWrappedInItemResponse() {
        ...
        withPrincipal(principal, () -> {
            CustomerApiController controller = new CustomerApiController(service, mock(com.xqt.saas.rates.RateEngine.class), mock(com.xqt.saas.tracking.TrackingAggregator.class), mock(com.xqt.saas.acc.AccFinanceWorkbenchController.class));
