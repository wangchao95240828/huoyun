...
class CustomerApiContractTests {
    ...
    void comparisonCaseAccBalanceResponseShape() {
        ...
        CustomerApiService service = new CustomerApiService(repository, json, jdbc, new CarrierGatewayRegistry(java.util.List.of(new NoopCarrierGateway()), new NoopCarrierGateway(), jdbc));
