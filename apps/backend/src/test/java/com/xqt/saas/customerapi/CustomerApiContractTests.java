...
class CustomerApiContractTests {
    ...
    void comparisonCaseAccBalanceResponseShape() {
        ...
        CustomerApiService service = new CustomerApiService(repository, json, jdbc, new CarrierGatewayRegistry(java.util.List.of(new NoopCarrierGateway()), new NoopCarrierGateway(), jdbc), org.mockito.Mockito.mock(com.xqt.saas.rates.RateEngine.class), org.mockito.Mockito.mock(com.xqt.saas.customerapi.SubmitCompensationService.class), org.mockito.Mockito.mock(com.xqt.saas.webhook.WebhookService.class));
