...
/**
 * /api/acc/supplier-sponsors — 供应商押金/预存款（对应 ACC SSponsor.php）
 * 业务侧：发件人押金 / 海外仓预收等。
 */
@RestController
@RequestMapping("/api/acc/supplier-sponsors")
public class AccSupplierSponsorsController extends AccFinanceTxnsBase {
    private final BranchAccessFilter branchAccess;

    public AccSupplierSponsorsController(JdbcTemplate jdbc, JsonSupport json,
    ...
    @Override protected String labelCn() { return "供应商押金"; }
