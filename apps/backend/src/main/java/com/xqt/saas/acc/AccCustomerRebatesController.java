...
@RestController
@RequestMapping("/api/acc/customer-rebates")
public class AccCustomerRebatesController extends AccFinanceTxnsBase {
        private final BranchAccessFilter branchAccess;

public AccCustomerRebatesController(JdbcTemplate jdbc, JsonSupport json,
    ...
    @Override protected String labelCn() { return "客户返利"; }
