...
@RestController
@RequestMapping("/api/acc/supplier-adjusts")
public class AccSupplierAdjustsController extends AccFinanceTxnsBase {
    public AccSupplierAdjustsController(JdbcTemplate jdbc, JsonSupport json,
    ...
    @Override protected String labelCn() { return "物流商调账"; }
