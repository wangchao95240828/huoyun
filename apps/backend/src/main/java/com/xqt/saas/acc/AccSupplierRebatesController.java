...
@RestController
@RequestMapping("/api/acc/supplier-rebates")
public class AccSupplierRebatesController extends AccFinanceTxnsBase {
    public AccSupplierRebatesController(JdbcTemplate jdbc, JsonSupport json,
    ...
    @Override protected String txnType() { return "REBATE"; }
    @Override protected String labelCn() { return "物流商返利"; }
